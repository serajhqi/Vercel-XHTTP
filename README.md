...
> نصب خودکار مراحل ۴ تا ۶

محتوای فایل `setup_vps.sh` را در یک فایل در سرور کپی و اجرا کنید. موارد ورودی را وارد و آن را اجرا کنید. اسکریپت مراحل را خودکار طی میکند.
```bash
nano setup.sh
# محتوا را داخل فایل وارد کنید و سپس CTRL + O و CTRL + X
chmod +x setup.sh
./setup.sh
```
